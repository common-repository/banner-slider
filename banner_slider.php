...
Plugin URI: https://wordpress.org/plugins/banner-slider/
...
Author URI: http://ajtechbd.com/about-us
...
<?php if(isset($_POST['submitBtn'])){
	update_option('aj_slideshow_width',$_POST['aj_slideshow_width']);
	update_option('aj_slideshow_height',$_POST['aj_slideshow_width']);
	
	update_option('aj_slideshow_thumbnail_bar',$_POST['aj_slideshow_thumbnail_bar']);
	update_option('aj_slideshow_thumb_width',$_POST['aj_slideshow_thumb_width']);
	update_option('aj_slideshow_thumb_height',$_POST['aj_slideshow_thumb_height']);
...
<td align="left" width="200">
<label><input type="radio" <?php if(get_option('aj_slideshow_thumbnail_bar')=='' OR get_option('aj_slideshow_thumbnail_bar')=='1') echo 'checked="checked"'; ?> name="aj_slideshow_thumbnail_bar" value="1">Yes</label>  <label><input type="radio" <?php if(get_option('aj_slideshow_thumbnail_bar')=='0') echo 'checked="checked"'; ?> name="aj_slideshow_thumbnail_bar" value="0">No</label>
</td>
<td align="left"></td>
</tr>
...
<td align="left" width="200">
<input type="text" name="aj_slideshow_thumb_width" value="<?php echo get_option('aj_slideshow_thumb_width'); ?>">
</td>
<td align="left"></td>
</tr>
...
<td align="left" width="200">
<input type="text" name="aj_slideshow_thumb_height" value="<?php echo get_option('aj_slideshow_thumb_height'); ?>">
</td>
<td align="left"></td>
</tr>
